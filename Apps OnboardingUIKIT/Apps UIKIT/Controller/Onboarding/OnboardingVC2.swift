...
class OnboardingVC2: UIViewController {
    ...
    lazy var imageWork : UIImageView = {
        let imageWork = UIImageView ()
        imageWork.image = UIImage(named: "work")
    ...
    lazy var titleLabel : UILabel = {
        let label = UILabel()
        label.text = "Your Onboarding Journey Begins!"
    ...
    override func viewDidLoad() {
        ...
        //image work
        view.addSubview(imageWork)
        imageWork.translatesAutoresizingMaskIntoConstraints = false
        NSLayoutConstraint.activate([
            imageWork.topAnchor.constraint(equalTo: self.view.topAnchor, constant:160),
            imageWork.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 78),
            imageWork.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: 0),
            imageWork.heightAnchor.constraint(equalToConstant: 318)
        ])
